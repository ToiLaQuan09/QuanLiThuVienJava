 ...
 * @author Admin
 */
public class ThemSachMuon extends javax.swing.JFrame {

    /**
     * Creates new form ThemSachMuon
     */
    public ThemSachMuon() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String idSV = jTextField1.getText();
        ...
        MuonTra muonTra = new MuonTra(idSV, tenSV, ngaySinh, lop, khoa, maSach, tenSach, ngayMuon, soLuong);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemSachMuon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemSachMuon().setVisible(true);
            }
        });
    }
